...
$('#jugar').click(function () {
    hacerSonido('boton1');
    if (usuarioLocalStorage && usuarioLocalStorage != '') {
        nombreUsuario = usuarioLocalStorage;
        prepararJuego();
    } else {
...
const usuarioBoton = document.querySelector('.pantallaFinal .usuario-eliminar');
usuarioBoton.addEventListener('click', () => {
    localStorage.removeItem('user');
    usuarioBoton.parentNode.classList.add('usuario--eliminado');
})
